...
impl Encoder {
    ...
    fn error_correct(&self, mut encode: Vec<u8>, version: usize, ec_level: usize) -> Vec<u8> {
        ...
        let re_codewords = self.codewords[version][ec_level].0 - encode.len() as u32 / 8;
    ...
    pub fn encode(&self, mode: &str, version: &str, ec_level: &str, text: &str) {
        ...
        let ec_codewords_per_block = self.codewords[version][ec_level].1;
